...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'crated by DWI STORE', imageMessage: imageMsg,

              contentText:`jangan lupa subs yt DWI STORE`,buttons,headerType:4}
...
anu = await fetchJson(`https://leyscoders-api.herokuapp.com/api/ppcouple?apikey=IkyOgiwara`)
              ...
              buttonsMessage = {footerText:'crated DWI STORE', imageMessage: imageMsg,
...
//------------------< Menunya Bang:v >-------------------
      ...
      case 'don':
             ...
             reply(`DONASI DANA 085921169048`)
